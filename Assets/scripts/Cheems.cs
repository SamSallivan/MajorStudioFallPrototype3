...
public class Cheems : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (health == 1)
        {
            ...
            this.GetComponent<Renderer>().material.SetColor("_color",Color.Lerp(Color.white, Color.red, time1/0.5f));
            this.transform.GetChild(0).gameObject.SetActive(false);
            this.transform.GetChild(1).gameObject.SetActive(true);
             this.transform.GetChild(1).GetComponent<SpriteRenderer>().color = Color.Lerp(Color.white, Color.red, time1/0.5f);
        }
